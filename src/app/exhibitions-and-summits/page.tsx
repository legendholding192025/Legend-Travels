        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-2xl font-bold mb-4 font-helvetica">Event Planning</h3>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-2xl font-bold mb-4 font-helvetica">Delegate Management</h3>
              <p className="text-gray-600 font-helvetica">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-2xl font-bold mb-4 font-helvetica">Venue Management</h3>
              <p className="text-gray-600 font-helvetica">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-2xl font-bold mb-4 font-helvetica">Technology Solutions</h3>
              <p className="text-gray-600 font-helvetica">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-2xl font-bold mb-4 font-helvetica">24/7 Support</h3>
              <p className="text-gray-600 font-helvetica">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-2xl font-bold mb-4 font-helvetica">Risk Management</h3>
              <p className="text-gray-600 font-helvetica">
